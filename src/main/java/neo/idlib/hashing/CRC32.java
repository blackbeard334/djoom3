...
public class CRC32 {
    ...
    static final long CRC32_INIT_VALUE = 0xffffffffL;
    static final long CRC32_XOR_VALUE = 0xffffffffL;
    ...
    public static void CRC32_InitChecksum(long[] crcvalue) {
        crcvalue[0] = CRC32_INIT_VALUE;
    }

    public static void CRC32_Update(long[] crcvalue, final byte data) {
    ...
    public static void CRC32_UpdateChecksum(long[] crcvalue, final char[] data, int length) {
        ...
        crc = crcvalue[0];
        while (length-- != 0) {
            crc = crctable[ (int) (crc ^ data[buf++]) & 0xff] ^ (crc >> 8);
        }
        crcvalue[0] = crc;
    }

    public static void CRC32_FinishChecksum(long[] crcvalue) {
        crcvalue[0] ^= CRC32_XOR_VALUE;
    }
