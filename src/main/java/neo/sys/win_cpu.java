...
//	return true;
    ...
    /*
     ...
     ================
     */
    public static void CPUID(int func, int[] regs/*[4]*/) {
        throw new TODO_Exception();
...
//	return false;
    ...
    /*
     ...
     ================
     */
    public static char LogicalProcPerPhysicalProc() {
        throw new TODO_Exception();
...
//	return ( ( dwMask & ( 1 << 6 ) ) == ( 1 << 6 ) );	// Return if the DAZ bit is set
    ...
    /*
     ...
     ===============
     */
    public static int Sys_FPU_PrintStateFlags(String ptr, int ctrl, int stat, int tags, int inof, int inse, int opof, int opse) {
        throw new TODO_Exception();
//	int i, length = 0;
//
...
//	return length;
    ...
    /*
     ...
     ===============
     */
    public static boolean Sys_FPU_StackIsEmpty() {
        throw new TODO_Exception();
//	__asm {
//		mov			eax, statePtr
//		fnstenv		[eax]
...
//	return true;
    ...
    /*
     ...
     ===============
     */
    public static void Sys_FPU_ClearStack() {
        throw new TODO_Exception();
//	__asm {
//		mov			eax, statePtr
//		fnstenv		[eax]
...
//	}
    ...
    /*
     ...
     ===============
     */
    public static String Sys_FPU_GetState() {
        throw new TODO_Exception();
...
//	return fpuString;
    ...
    /*
     ...
     ===============
     */
    public static void Sys_FPU_EnableExceptions(int exceptions) {
        throw new TODO_Exception();
//	__asm {
//		mov			eax, statePtr
//		mov			ecx, exceptions
...
//	}
    ...
    /*
     ...
     ===============
     */
    public static void Sys_FPU_SetPrecision(int precision) {
        throw new TODO_Exception();
...
//	}
    ...
    /*
     ...
     ================
     */
    public static void Sys_FPU_SetRounding(int rounding) {
        throw new TODO_Exception();
...
//	}
    ...
    /*
     ...
     ================
     */
    public static void Sys_FPU_SetDAZ(boolean enable) {
        throw new TODO_Exception();
//	DWORD dwData;
//
//	_asm {
...
//	}
    ...
    /*
     ...
     ================
     */
    public static void Sys_FPU_SetFTZ(boolean enable) {
        throw new TODO_Exception();
//	DWORD dwData;
//
//	_asm {
