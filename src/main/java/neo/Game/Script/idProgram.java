...
//	}
    ...
    public boolean CompileText(final String source, final String text, boolean console) {
        ...
        try {
            compiler.CompileFile(text, this.filename.toString(), console);
...
//	memset( variables, 0, sizeof( variables ) );
    ...
    public String GetFilename(int num) {
        return this.fileList.oGet(num).toString();
    }
...
//                memset(def.value.bytePtr, 0, def.TypeDef().Size());
    ...
    public function_t FindFunction(final String name) {				// returns NULL if function not found
        ...
        do {
            ...
            final String namespaceName = fullname.Mid(start, pos - start).toString();
        ...
        final String funcName = fullname.Right(fullname.Length() - start).toString();
