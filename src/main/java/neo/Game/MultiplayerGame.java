...
//	idStr strReady = cvarSystem.GetCVarString( "ui_ready" );
            ...
            for (i = 0; i < gameLocal.serverInfo.GetNumKeyVals(); i++) {
                ...
                mainGui.SetStateString(keyval.GetKey().getData(), keyval.GetValue().getData());
            }
        ...
        public void ExecuteVote() {
            ...
            switch (vote) {
                ...
                case VOTE_FRAGLIMIT:
                    ...
                    break;
                case VOTE_GAMETYPE:
                    si_gameType.SetString(voteValue.getData());
                    gameLocal.MapRestart();
                    break;
                case VOTE_KICK:
                    ...
                    break;
                case VOTE_MAP:
                    si_map.SetString(voteValue.getData());
                    gameLocal.MapRestart();
                    break;
                case VOTE_SPECTATORS:
            ...
            if (guiChat != null) {
                ...
                if (chatDataUpdated) {
                    ...
                    while (i < chatHistoryIndex) {
                        guiChat.SetStateString(va("chat%d", j), chatHistory[i % NUM_CHAT_NOTIFY].line.getData());
