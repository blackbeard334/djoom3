...
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE0_ARB;
import static neo.Renderer.opengl.QGLConst.GL_ADD;
...
import static neo.Renderer.opengl.QGLConst.GL_COLOR_BUFFER_BIT;
import static neo.Renderer.opengl.QGLConst.GL_CULL_FACE;
import static neo.Renderer.opengl.QGLConst.GL_DECAL;
import static neo.Renderer.opengl.QGLConst.GL_DEPTH_TEST;
import static neo.Renderer.opengl.QGLConst.GL_DST_ALPHA;
import static neo.Renderer.opengl.QGLConst.GL_DST_COLOR;
import static neo.Renderer.opengl.QGLConst.GL_EQUAL;
import static neo.Renderer.opengl.QGLConst.GL_FILL;
import static neo.Renderer.opengl.QGLConst.GL_FRONT;
import static neo.Renderer.opengl.QGLConst.GL_FRONT_AND_BACK;
import static neo.Renderer.opengl.QGLConst.GL_GEQUAL;
import static neo.Renderer.opengl.QGLConst.GL_LEQUAL;
import static neo.Renderer.opengl.QGLConst.GL_LESS;
import static neo.Renderer.opengl.QGLConst.GL_LIGHTING;
import static neo.Renderer.opengl.QGLConst.GL_LINE;
import static neo.Renderer.opengl.QGLConst.GL_LINE_STIPPLE;
...
import static neo.Renderer.opengl.QGLConst.GL_ONE_MINUS_DST_ALPHA;
import static neo.Renderer.opengl.QGLConst.GL_ONE_MINUS_DST_COLOR;
import static neo.Renderer.opengl.QGLConst.GL_ONE_MINUS_SRC_ALPHA;
...
import static neo.Renderer.opengl.QGLConst.GL_REPLACE;
import static neo.Renderer.opengl.QGLConst.GL_S;
import static neo.Renderer.opengl.QGLConst.GL_SCISSOR_TEST;
import static neo.Renderer.opengl.QGLConst.GL_SMOOTH;
import static neo.Renderer.opengl.QGLConst.GL_SRC_ALPHA;
import static neo.Renderer.opengl.QGLConst.GL_SRC_ALPHA_SATURATE;
...
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_ENV_MODE;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_MODE;
import static neo.Renderer.opengl.QGLConst.GL_VERTEX_ARRAY;
import static neo.Renderer.opengl.QGLConst.GL_ZERO;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_3D;
import static neo.Renderer.opengl.QGLConst.GL_COMBINE;
