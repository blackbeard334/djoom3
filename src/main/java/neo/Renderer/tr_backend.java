...
import static neo.opengl.QGL.qglClearDepth;
import static neo.opengl.QGL.qglClientActiveTextureARB;
import static neo.opengl.QGL.qglColor4f;
import static neo.opengl.QGL.qglColorMask;
...
import static neo.opengl.QGL.qglDrawBuffer;
...
import static neo.opengl.QGL.qglPolygonMode;
import static neo.opengl.QGL.qglScissor;
import static neo.opengl.QGL.qglShadeModel;
...
import static neo.opengl.QGLConstantsIfc.GL_ADD;
...
import static neo.opengl.QGLConstantsIfc.GL_COMBINE;
import static neo.opengl.QGLConstantsIfc.GL_CULL_FACE;
import static neo.opengl.QGLConstantsIfc.GL_DECAL;
import static neo.opengl.QGLConstantsIfc.GL_DEPTH_TEST;
import static neo.opengl.QGLConstantsIfc.GL_DST_ALPHA;
import static neo.opengl.QGLConstantsIfc.GL_DST_COLOR;
import static neo.opengl.QGLConstantsIfc.GL_EQUAL;
import static neo.opengl.QGLConstantsIfc.GL_FILL;
import static neo.opengl.QGLConstantsIfc.GL_FRONT;
import static neo.opengl.QGLConstantsIfc.GL_FRONT_AND_BACK;
import static neo.opengl.QGLConstantsIfc.GL_GEQUAL;
import static neo.opengl.QGLConstantsIfc.GL_LEQUAL;
import static neo.opengl.QGLConstantsIfc.GL_LESS;
import static neo.opengl.QGLConstantsIfc.GL_LIGHTING;
import static neo.opengl.QGLConstantsIfc.GL_LINE;
import static neo.opengl.QGLConstantsIfc.GL_LINE_STIPPLE;
...
import static neo.opengl.QGLConstantsIfc.GL_ONE_MINUS_DST_ALPHA;
import static neo.opengl.QGLConstantsIfc.GL_ONE_MINUS_DST_COLOR;
import static neo.opengl.QGLConstantsIfc.GL_ONE_MINUS_SRC_ALPHA;
...
import static neo.opengl.QGLConstantsIfc.GL_REPLACE;
import static neo.opengl.QGLConstantsIfc.GL_S;
import static neo.opengl.QGLConstantsIfc.GL_SCISSOR_TEST;
import static neo.opengl.QGLConstantsIfc.GL_SMOOTH;
import static neo.opengl.QGLConstantsIfc.GL_SRC_ALPHA;
import static neo.opengl.QGLConstantsIfc.GL_SRC_ALPHA_SATURATE;
...
import static neo.opengl.QGLConstantsIfc.GL_TEXTURE0_ARB;
...
import static neo.opengl.QGLConstantsIfc.GL_TEXTURE_ENV_MODE;
import static neo.opengl.QGLConstantsIfc.GL_TEXTURE_GEN_MODE;
import static neo.opengl.QGLConstantsIfc.GL_VERTEX_ARRAY;
import static neo.opengl.QGLConstantsIfc.GL_ZERO;
