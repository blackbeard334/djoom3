...
import static neo.Renderer.opengl.QGLConst.GL_COMBINE_ALPHA_ARB;
import static neo.Renderer.opengl.QGLConst.GL_COMBINE_ARB;
import static neo.Renderer.opengl.QGLConst.GL_COMBINE_RGB_ARB;
import static neo.Renderer.opengl.QGLConst.GL_CONSTANT_ARB;
import static neo.Renderer.opengl.QGLConst.GL_OPERAND0_ALPHA_ARB;
import static neo.Renderer.opengl.QGLConst.GL_OPERAND0_RGB_ARB;
import static neo.Renderer.opengl.QGLConst.GL_OPERAND1_ALPHA_ARB;
import static neo.Renderer.opengl.QGLConst.GL_OPERAND1_RGB_ARB;
import static neo.Renderer.opengl.QGLConst.GL_PREVIOUS_ARB;
import static neo.Renderer.opengl.QGLConst.GL_PRIMARY_COLOR_ARB;
import static neo.Renderer.opengl.QGLConst.GL_RGB_SCALE_ARB;
import static neo.Renderer.opengl.QGLConst.GL_SOURCE0_ALPHA_ARB;
import static neo.Renderer.opengl.QGLConst.GL_SOURCE0_RGB_ARB;
import static neo.Renderer.opengl.QGLConst.GL_SOURCE1_ALPHA_ARB;
import static neo.Renderer.opengl.QGLConst.GL_SOURCE1_RGB_ARB;
import static neo.Renderer.opengl.QGLConst.GL_VERTEX_PROGRAM_ARB;
import static neo.Renderer.opengl.QGLConst.GL_DEPTH_BOUNDS_TEST_EXT;
import static neo.Renderer.opengl.QGLConst.GL_ALPHA_SCALE;
import static neo.Renderer.opengl.QGLConst.GL_ALPHA_TEST;
import static neo.Renderer.opengl.QGLConst.GL_ALWAYS;
import static neo.Renderer.opengl.QGLConst.GL_COLOR_ARRAY;
import static neo.Renderer.opengl.QGLConst.GL_DEPTH_TEST;
import static neo.Renderer.opengl.QGLConst.GL_FLOAT;
import static neo.Renderer.opengl.QGLConst.GL_GEQUAL;
import static neo.Renderer.opengl.QGLConst.GL_GREATER;
import static neo.Renderer.opengl.QGLConst.GL_KEEP;
import static neo.Renderer.opengl.QGLConst.GL_MODELVIEW;
import static neo.Renderer.opengl.QGLConst.GL_MODULATE;
import static neo.Renderer.opengl.QGLConst.GL_NORMAL_ARRAY;
import static neo.Renderer.opengl.QGLConst.GL_OBJECT_LINEAR;
import static neo.Renderer.opengl.QGLConst.GL_OBJECT_PLANE;
import static neo.Renderer.opengl.QGLConst.GL_ONE_MINUS_SRC_COLOR;
import static neo.Renderer.opengl.QGLConst.GL_POLYGON_OFFSET_FILL;
import static neo.Renderer.opengl.QGLConst.GL_PROJECTION;
import static neo.Renderer.opengl.QGLConst.GL_Q;
import static neo.Renderer.opengl.QGLConst.GL_QUADS;
import static neo.Renderer.opengl.QGLConst.GL_R;
import static neo.Renderer.opengl.QGLConst.GL_S;
import static neo.Renderer.opengl.QGLConst.GL_SRC_ALPHA;
import static neo.Renderer.opengl.QGLConst.GL_SRC_COLOR;
import static neo.Renderer.opengl.QGLConst.GL_STENCIL_TEST;
import static neo.Renderer.opengl.QGLConst.GL_T;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_COORD_ARRAY;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_ENV;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_ENV_COLOR;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_MODE;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_Q;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_R;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_S;
import static neo.Renderer.opengl.QGLConst.GL_TEXTURE_GEN_T;
import static neo.Renderer.opengl.QGLConst.GL_UNSIGNED_BYTE;
import static neo.Renderer.opengl.QGLConst.GL_REFLECTION_MAP;
