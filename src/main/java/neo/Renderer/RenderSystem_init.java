...
import static neo.Renderer.opengl.QGLConst.GL_MAX_TEXTURE_COORDS_ARB;
import static neo.Renderer.opengl.QGLConst.GL_MAX_TEXTURE_IMAGE_UNITS_ARB;
import static neo.Renderer.opengl.QGLConst.GL_MAX_TEXTURE_UNITS_ARB;
import static neo.Renderer.opengl.QGLConst.GL_DECR_WRAP_EXT;
import static neo.Renderer.opengl.QGLConst.GL_INCR_WRAP_EXT;
import static neo.Renderer.opengl.QGLConst.GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT;
import static neo.Renderer.opengl.QGLConst.GL_DECR;
import static neo.Renderer.opengl.QGLConst.GL_EXTENSIONS;
import static neo.Renderer.opengl.QGLConst.GL_FRONT;
import static neo.Renderer.opengl.QGLConst.GL_INCR;
import static neo.Renderer.opengl.QGLConst.GL_INVALID_ENUM;
import static neo.Renderer.opengl.QGLConst.GL_INVALID_OPERATION;
import static neo.Renderer.opengl.QGLConst.GL_INVALID_VALUE;
import static neo.Renderer.opengl.QGLConst.GL_MAX_TEXTURE_SIZE;
import static neo.Renderer.opengl.QGLConst.GL_NO_ERROR;
import static neo.Renderer.opengl.QGLConst.GL_OUT_OF_MEMORY;
import static neo.Renderer.opengl.QGLConst.GL_RENDERER;
import static neo.Renderer.opengl.QGLConst.GL_RGB;
import static neo.Renderer.opengl.QGLConst.GL_STACK_OVERFLOW;
import static neo.Renderer.opengl.QGLConst.GL_STACK_UNDERFLOW;
import static neo.Renderer.opengl.QGLConst.GL_STENCIL_INDEX;
import static neo.Renderer.opengl.QGLConst.GL_UNSIGNED_BYTE;
import static neo.Renderer.opengl.QGLConst.GL_VENDOR;
import static neo.Renderer.opengl.QGLConst.GL_VERSION;
