...
//    public static void qglCombinerParameterfvNV(int pName, final float[] params) {
...
//        public static /*PFNGLGENFRAGMENTSHADERSATIPROC*/    void qglGenFragmentShadersATI(int range) {
//        }
//
//        public static /*PFNGLBINDFRAGMENTSHADERATIPROC*/void qglBindFragmentShaderATI(int id) {
//        }
//
//        public static /*PFNGLDELETEFRAGMENTSHADERATIPROC*/void qglDeleteFragmentShaderATI(int id) {
//        }
//
//        public static /*PFNGLBEGINFRAGMENTSHADERATIPROC*/void qglBeginFragmentShaderATI() {
//        }
//
//        public static /*PFNGLENDFRAGMENTSHADERATIPROC*/void qglEndFragmentShaderATI() {
//        }
//
//        public static /*PFNGLPASSTEXCOORDATIPROC*/void qglPassTexCoordATI(int dst, int coord, int swizzle) {
//        }
//
//        public static /*PFNGLSAMPLEMAPATIPROC*/void qglSampleMapATI(int dst, int interp, int swizzle) {
//        }
//
//        public static /*PFNGLCOLORFRAGMENTOP1ATIPROC*/void qglColorFragmentOp1ATI(int op, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod) {
//        }
//
//        public static /*PFNGLCOLORFRAGMENTOP2ATIPROC*/void qglColorFragmentOp2ATI(int op, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod) {
//        }
//
//        public static /*PFNGLCOLORFRAGMENTOP3ATIPROC*/void qglColorFragmentOp3ATI(int op, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod) {
//        }
//
//        public static /*PFNGLALPHAFRAGMENTOP1ATIPROC*/void qglAlphaFragmentOp1ATI(int op, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod) {
//        }
//
//        public static /*PFNGLALPHAFRAGMENTOP2ATIPROC*/void qglAlphaFragmentOp2ATI(int op, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod) {
//        }
//
//        public static /*PFNGLALPHAFRAGMENTOP3ATIPROC*/void qglAlphaFragmentOp3ATI(int op, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod) {
//        }
//
//        public static /*PFNGLSETFRAGMENTSHADERCONSTANTATIPROC*/void qglSetFragmentShaderConstantATI(int dst, final float[] value) {
//        }
//    }
//
...
//
//    @Deprecated
//    public static void qglCompressedTexImage2DARB(int target, int level, int internalformat, int width, int height, int border, int imageSize, long pData_buffer_offset) {
...
//    @Deprecated
//    public static void /*PFNGLVERTEXATTRIBPOINTERARBPROC*/ qglVertexAttribPointerARB(int index, int size, int type, boolean normalized, int stride, float[] pointer) {
...
////    }
//    public static void qglAccum(int op, float value) {DEBUG_printName("glAccum");
...
//    }
//
//    public static boolean qglAreTexturesResident(int n, IntBuffer textures, ByteBuffer residences) {DEBUG_printName("glAreTexturesResident");
...
//    }
//
//    public static void qglBitmap(int width, int height, float xorig, float yorig, float xmove, float ymove, ByteBuffer bitmap) {DEBUG_printName("glBitmap");
...
//    }
//
//    public static void qglCallList(int list) {DEBUG_printName("glCallList");
//        GL11.glCallList(list);
//    }
//
//    public static void qglCallLists(int n, int type, Object lists) {
...
//    }
//
//    public static void qglClearAccum(float red, float green, float blue, float alpha) {DEBUG_printName("glClearAccum");
...
//    }
//
//    public static void qglClearIndex(float c) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglClipPlane(int plane, DoubleBuffer equation) {DEBUG_printName("glClipPlane");
//        GL11.glClipPlane(plane, equation);
//    }
//
//    public static void qglColor3b(byte red, byte green, byte blue) {DEBUG_printName("glColor3b");
//        GL11.glColor3b(red, green, blue);
//    }
//
//    public static void qglColor3bv(byte[] v) {DEBUG_printName("glColor3bv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3d(double red, double green, double blue) {DEBUG_printName("glColor3d");
//        GL11.glColor3d(red, green, blue);
//    }
//
//    public static void qglColor3dv(double[] v) {DEBUG_printName("glColor3dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglColor3i(int red, int green, int blue) {DEBUG_printName("glColor3i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3iv(int[] v) {DEBUG_printName("glColor3iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3s(short red, short green, short blue) {DEBUG_printName("glColor3s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3sv(short[] v) {DEBUG_printName("glColor3sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3ub(byte red, byte green, byte blue) {DEBUG_printName("glColor3ub");
...
//    }
//
//    public static void qglColor3ui(int red, int green, int blue) {DEBUG_printName("glColor3ui");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3uiv(int[] v) {DEBUG_printName("glColor3uiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3us(short red, short green, short blue) {DEBUG_printName("glColor3us");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor3usv(short[] v) {DEBUG_printName("glColor3usv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4b(byte red, byte green, byte blue, byte alpha) {DEBUG_printName("glColor4b");
//        GL11.glColor4b(red, green, blue, alpha);
//    }
//
//    public static void qglColor4bv(byte[] v) {DEBUG_printName("glColor4bv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4d(double red, double green, double blue, double alpha) {DEBUG_printName("glColor4d");
//        GL11.glColor4d(red, green, blue, alpha);
//    }
//
//    public static void qglColor4dv(double[] v) {DEBUG_printName("glColor4dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglColor4i(int red, int green, int blue, int alpha) {DEBUG_printName("glColor4i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4iv(int[] v) {DEBUG_printName("glColor4iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4s(short red, short green, short blue, short alpha) {DEBUG_printName("glColor4s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4sv(short[] v) {DEBUG_printName("glColor4sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglColor4ub(byte red, byte green, byte blue, byte alpha) {DEBUG_printName("glColor4ub");
...
//    }
//
//    public static void qglColor4uiv(int[] v) {DEBUG_printName("glColor4uiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglColorMaterial(int face, int mode) {DEBUG_printName("glColorMaterial");
...
//
//    @Deprecated
//    public static void qglColorPointer(int size, int type, int stride, Object pointer) {DEBUG_printName("glColorPointer");
////        GL11.glColorPointer(size, type, stride, );
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglCopyPixels(int x, int y, int width, int height, int type) {DEBUG_printName("glCopyPixels");
//        GL11.glCopyPixels(x, y, width, height, type);
//    }
//
//    public static void qglCopyTexImage1D(int target, int level, int internalFormat, int x, int y, int width, int border) {DEBUG_printName("glCopyTexImage1D");
...
//    }
//
//    public static void qglCopyTexSubImage1D(int target, int level, int xoffset, int x, int y, int width) {DEBUG_printName("glCopyTexSubImage1D");
...
//    }
//
//    public static void qglDeleteLists(int list, int range) {DEBUG_printName("glDeleteLists");
...
//    }
//
//    public static void qglDeleteTextures(int n, int[] textures) {DEBUG_printName("glDeleteTextures");
...
//    }
//
//    public static void qglDrawArrays(int mode, int first, int count) {DEBUG_printName("glDrawArrays");
...
//    }
//
//    public static void qglEdgeFlag(boolean flag) {DEBUG_printName("glEdgeFlag");
//        GL11.glEdgeFlag(flag);
//    }
//
//    public static void qglEdgeFlagPointer(int stride, Object pointer) {DEBUG_printName("glEdgeFlagPointer");
////        GL11.glEdgeFlagPointer(stride, );
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglEdgeFlagv(boolean flag) {DEBUG_printName("glEdgeFlagv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglEvalCoord1d(double u) {DEBUG_printName("glEvalCoord1d");
//        GL11.glEvalCoord1d(u);
//    }
//
//    public static void qglEvalCoord1dv(double[] u) {DEBUG_printName("glEvalCoord1dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglEvalCoord1f(float u) {DEBUG_printName("glEvalCoord1f");
//        GL11.glEvalCoord1f(u);
//    }
//
//    public static void qglEvalCoord1fv(float[] u) {DEBUG_printName("glEvalCoord1fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglEvalCoord2d(double u, double v) {DEBUG_printName("glEvalCoord2d");
//        GL11.glEvalCoord2d(u, v);
//    }
//
//    public static void qglEvalCoord2dv(double[] u) {DEBUG_printName("glEvalCoord2dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglEvalCoord2f(float u, float v) {DEBUG_printName("glEvalCoord2f");
//        GL11.glEvalCoord2f(u, v);
//    }
//
//    public static void qglEvalCoord2fv(float[] u) {DEBUG_printName("glEvalCoord2fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglEvalMesh1(int mode, int i1, int i2) {DEBUG_printName("glEvalMesh1");
//        GL11.glEvalMesh1(mode, i1, i2);
//    }
//
//    public static void qglEvalMesh2(int mode, int i1, int i2, int j1, int j2) {DEBUG_printName("glEvalMesh2");
//        GL11.glEvalMesh2(mode, i1, i2, j1, j2);
//    }
//
//    public static void qglEvalPoint1(int i) {DEBUG_printName("glEvalPoint1");
//        GL11.glEvalPoint1(i);
//    }
//
//    public static void qglEvalPoint2(int i, int j) {DEBUG_printName("glEvalPoint2");
//        GL11.glEvalPoint2(i, j);
//    }
//
//    public static void qglFeedbackBuffer(int size, int type, FloatBuffer buffer) {DEBUG_printName("glFeedbackBuffer");
...
//    }
//
//    public static void qglFogf(int pName, float param) {DEBUG_printName("glFogf");
//        GL11.glFogf(pName, param);
//    }
//
//    public static void qglFogfv(int pName, float[] params) {DEBUG_printName("glFogfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglFogi(int pName, int param) {DEBUG_printName("glFogi");
//        GL11.glFogi(pName, param);
//    }
//
//    public static void qglFogiv(int pName, int[] params) {DEBUG_printName("glFogiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static int qglGenLists(Enum range) {
//        return qglGenLists(range.ordinal());
//    }
//
//    public static int qglGenLists(int range) {DEBUG_printName("glGenLists");
...
//    }
//
//    public static void qglGenTextures(int n, int[] textures) {DEBUG_printName("glGenTextures");
//        GL11.glGenTextures();
//    }
//
//    public static void qglGetBooleanv(int pName, boolean[] params) {DEBUG_printName("glGetBooleanv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetClipPlane(int plane, DoubleBuffer equation) {DEBUG_printName("glGetClipPlane");
//        GL11.glGetClipPlane(plane, equation);
//    }
//
//    public static void qglGetDoublev(int pName, double[] params) {DEBUG_printName("glGetDoublev");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglGetLightiv(int light, int pName, int[] params) {DEBUG_printName("glGetLightiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetMapdv(int target, int query, double[] v) {DEBUG_printName("glGetMapdv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetMapfv(int target, int query, float[] v) {DEBUG_printName("glGetMapfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetMapiv(int target, int query, int[] v) {DEBUG_printName("glGetMapiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetMaterialfv(int face, int pName, float[] params) {DEBUG_printName("glGetMaterialfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetMaterialiv(int face, int pName, int[] params) {DEBUG_printName("glGetMaterialiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetPixelMapfv(int map, float[] values) {DEBUG_printName("glGetPixelMapfv");
////        GL11.glGetPixelMapfv(map, );
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetPixelMapuiv(int map, int[] values) {DEBUG_printName("glGetPixelMapuiv");
////        GL11.glGetPixelMapuiv(map, );
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetPixelMapusv(int map, short[] values) {DEBUG_printName("glGetPixelMapusv");
////        GL11.glGetPixelMapusv(map, );
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetPointerv(int pName, Object[] params) {DEBUG_printName("glGetPointerv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetPolygonStipple(byte mask) {DEBUG_printName("glGetPolygonStipple");
...
//    }
//
//    public static void qglGetTexEnviv(int target, int pName, int[] params) {DEBUG_printName("glGetTexEnviv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexGendv(int coord, int pName, double[] params) {DEBUG_printName("glGetTexGendv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexGenfv(int coord, int pName, float[] params) {DEBUG_printName("glGetTexGenfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexGeniv(int coord, int pName, int[] params) {DEBUG_printName("glGetTexGeniv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglGetTexLevelParameterfv(int target, int level, int pName, float[] params) {DEBUG_printName("glGetTexLevelParameterfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexLevelParameteriv(int target, int level, int pName, int[] params) {DEBUG_printName("glGetTexLevelParameteriv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexParameterfv(int target, int pName, float[] params) {DEBUG_printName("glGetTexParameterfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglGetTexParameteriv(int target, int pName, int[] params) {DEBUG_printName("glGetTexParameteriv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglHint(int target, int mode) {DEBUG_printName("glHint");
//        GL11.glHint(target, mode);
//    }
//
//    public static void qglIndexMask(int mask) {DEBUG_printName("glIndexMask");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexPointer(int type, int stride, Object pointer) {DEBUG_printName("glIndexPointer");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexd(double c) {DEBUG_printName("glIndexd");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexdv(double[] c) {DEBUG_printName("glIndexdv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexf(float c) {DEBUG_printName("glIndexf");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexfv(float[] c) {DEBUG_printName("glIndexfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexi(int c) {DEBUG_printName("glIndexi");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexiv(int[] c) {DEBUG_printName("glIndexiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexs(short c) {DEBUG_printName("glIndexs");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexsv(short[] c) {DEBUG_printName("glIndexsv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexub(byte c) {DEBUG_printName("glIndexub");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglIndexubv(byte[] c) {DEBUG_printName("glIndexubv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglInitNames() {DEBUG_printName("glInitNames");
//        GL11.glInitNames();
//    }
//
//    public static void qglInterleavedArrays(int format, int stride, ByteBuffer pointer) {DEBUG_printName("glInterleavedArrays");
//        GL11.glInterleavedArrays(format, stride, pointer);
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static boolean qglIsEnabled(int cap) {DEBUG_printName("glIsEnabled");
//        return GL11.glIsEnabled(cap);
//    }
//
//    public static boolean qglIsList(int list) {DEBUG_printName("glIsList");
//        return GL11.glIsList(list);
//    }
//
//    public static boolean qglIsTexture(int texture) {DEBUG_printName("glIsTexture");
//        return GL11.glIsTexture(texture);
//    }
//
//    public static void qglLightModelf(int pName, float param) {DEBUG_printName("glLightModelf");
...
//    }
//
//    public static void qglListBase(int base) {DEBUG_printName("glListBase");
...
//    }
//
//    public static void qglLogicOp(int opcode) {DEBUG_printName("glLogicOp");
//        GL11.glLogicOp(opcode);
//    }
//
//    public static void qglMap1d(int target, double u1, double u2, int stride, int order, DoubleBuffer points) {DEBUG_printName("glMap1d");
//        GL11.glMap1d(target, u1, u2, stride, order, points);
//    }
//
//    public static void qglMap1f(int target, float u1, float u2, int stride, int order, FloatBuffer points) {DEBUG_printName("glMap1f");
//        GL11.glMap1f(target, u1, u2, stride, order, points);
//    }
//
//    public static void qglMap2d(int target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, DoubleBuffer points) {DEBUG_printName("glMap2d");
//        GL11.glMap2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
//    }
//
//    public static void qglMap2f(int target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride, int vorder, FloatBuffer points) {DEBUG_printName("glMap2f");
//        GL11.glMap2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
//    }
//
//    public static void qglMapGrid1d(int un, double u1, double u2) {DEBUG_printName("glMapGrid1d");
//        GL11.glMapGrid1d(un, u1, u2);
//    }
//
//    public static void qglMapGrid1f(int un, float u1, float u2) {DEBUG_printName("glMapGrid1f");
//        GL11.glMapGrid1f(un, u1, u2);
//    }
//
//    public static void qglMapGrid2d(int un, double u1, double u2, int vn, double v1, double v2) {DEBUG_printName("glMapGrid2d");
//        GL11.glMapGrid2d(un, u1, u2, vn, v1, v2);
//    }
//
//    public static void qglMapGrid2f(int un, float u1, float u2, int vn, float v1, float v2) {DEBUG_printName("glMapGrid2f");
//        GL11.glMapGrid2f(un, u1, u2, vn, v1, v2);
//    }
//
//    public static void qglMaterialf(int face, int pName, float param) {DEBUG_printName("glMaterialf");
//        GL11.glMaterialf(face, pName, param);
//    }
//
//    public static void qglMaterialfv(int face, int pName, float[] params) {DEBUG_printName("glMaterialfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglMateriali(int face, int pName, int param) {DEBUG_printName("glMateriali");
//        GL11.glMateriali(face, pName, param);
//    }
//
//    public static void qglMaterialiv(int face, int pName, int[] params) {DEBUG_printName("glMaterialiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglMultMatrixd(double[] m) {DEBUG_printName("glMultMatrixd");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglMultMatrixf(float[] m) {DEBUG_printName("glMultMatrixf");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNewList(int list, int mode) {DEBUG_printName("glNewList");
//        GL11.glNewList(list, mode);
//    }
//
//    public static void qglNormal3b(byte nx, byte ny, byte nz) {DEBUG_printName("glNormal3b");
//        GL11.glNormal3b(nx, ny, nz);
//    }
//
//    public static void qglNormal3bv(byte[] v) {DEBUG_printName("glNormal3bv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNormal3d(double nx, double ny, double nz) {DEBUG_printName("glNormal3d");
//        GL11.glNormal3d(nx, ny, nz);
//    }
//
//    public static void qglNormal3dv(double[] v) {DEBUG_printName("glNormal3dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNormal3f(float nx, float ny, float nz) {DEBUG_printName("glNormal3f");
//        GL11.glNormal3f(nx, ny, nz);
//    }
//
//    public static void qglNormal3fv(float[] v) {DEBUG_printName("glNormal3fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNormal3i(int nx, int ny, int nz) {DEBUG_printName("glNormal3i");
//        GL11.glNormal3i(nx, ny, nz);
//    }
//
//    public static void qglNormal3iv(int[] v) {DEBUG_printName("glNormal3iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNormal3s(short nx, short ny, short nz) {DEBUG_printName("glNormal3s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglNormal3sv(short[] v) {DEBUG_printName("glNormal3sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglPassThrough(float token) {DEBUG_printName("glPassThrough");
//        GL11.glPassThrough(token);
//    }
//
//    public static void qglPixelMapfv(int map, int mapsize, float[] values) {DEBUG_printName("glPixelMapfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglPixelMapuiv(int map, int mapsize, int[] values) {DEBUG_printName("glPixelMapuiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglPixelMapusv(int map, int mapsize, short[] values) {DEBUG_printName("glPixelMapusv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglPixelStoref(int pName, float param) {DEBUG_printName("glPixelStoref");
...
//    }
//
//    public static void qglPixelTransferf(int pName, float param) {DEBUG_printName("glPixelTransferf");
//        GL11.glPixelTransferf(pName, param);
//    }
//
//    public static void qglPixelTransferi(int pName, int param) {DEBUG_printName("glPixelTransferi");
//        GL11.glPixelTransferi(pName, param);
//    }
//
//    public static void qglPixelZoom(float xfactor, float yfactor) {DEBUG_printName("glPixelZoom");
...
//    }
//
//    public static void qglPolygonStipple(ByteBuffer mask) {DEBUG_printName("glPolygonStipple");
...
//    }
//
//    public static void qglPopClientAttrib() {DEBUG_printName("glPopClientAttrib");
...
//    }
//
//    public static void qglPopName() {DEBUG_printName("glPopName");
//        GL11.glPopName();
//    }
//
...
//    }
//
//    public static void qglPrioritizeTextures(int n, IntBuffer textures, FloatBuffer priorities) {DEBUG_printName("glPrioritizeTextures");
...
//    }
//
//    public static void qglPushClientAttrib(int mask) {DEBUG_printName("glPushClientAttrib");
...
//    }
//
//    public static void qglPushName(int name) {DEBUG_printName("glPushName");
//        GL11.glPushName(name);
//    }
//
//    public static void qglRasterPos2d(double x, double y) {DEBUG_printName("glRasterPos2d");
//        GL11.glRasterPos2d(x, y);
//    }
//
//    public static void qglRasterPos2dv(double[] v) {DEBUG_printName("glRasterPos2dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglRasterPos2fv(float[] v) {DEBUG_printName("glRasterPos2fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos2i(int x, int y) {DEBUG_printName("glRasterPos2i");
//        GL11.glRasterPos2i(x, y);
//    }
//
//    public static void qglRasterPos2iv(int[] v) {DEBUG_printName("glRasterPos2iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos2s(short x, short y) {DEBUG_printName("glRasterPos2s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos2sv(short[] v) {DEBUG_printName("glRasterPos2sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos3d(double x, double y, double z) {DEBUG_printName("glRasterPos3d");
//        GL11.glRasterPos3d(x, y, z);
//    }
//
//    public static void qglRasterPos3dv(double[] v) {DEBUG_printName("glRasterPos3dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos3f(float x, float y, float z) {DEBUG_printName("glRasterPos3f");
//        GL11.glRasterPos3f(x, y, z);
//    }
//
//    public static void qglRasterPos3fv(float[] v) {DEBUG_printName("glRasterPos3fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos3i(int x, int y, int z) {DEBUG_printName("glRasterPos3i");
//        GL11.glRasterPos3i(x, y, z);
//    }
//
//    public static void qglRasterPos3iv(int[] v) {DEBUG_printName("glRasterPos3iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos3s(short x, short y, short z) {DEBUG_printName("glRasterPos3s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos3sv(short[] v) {DEBUG_printName("glRasterPos3sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos4d(double x, double y, double z, double w) {DEBUG_printName("glRasterPos4d");
//        GL11.glRasterPos4d(x, y, z, w);
//    }
//
//    public static void qglRasterPos4dv(double[] v) {DEBUG_printName("glRasterPos4dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos4f(float x, float y, float z, float w) {DEBUG_printName("glRasterPos4f");
//        GL11.glRasterPos4f(x, y, z, w);
//    }
//
//    public static void qglRasterPos4fv(float[] v) {DEBUG_printName("glRasterPos4fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos4i(int x, int y, int z, int w) {DEBUG_printName("glRasterPos4i");
//        GL11.glRasterPos4i(x, y, z, w);
//    }
//
//    public static void qglRasterPos4iv(int[] v) {DEBUG_printName("glRasterPos4iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos4s(short x, short y, short z, short w) {DEBUG_printName("glRasterPos4s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRasterPos4sv(short[] v) {DEBUG_printName("glRasterPos4sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglRectd(double x1, double y1, double x2, double y2) {DEBUG_printName("glRectd");
//        GL11.glRectd(x1, y1, x2, y2);
//    }
//
//    public static void qglRectdv(double[] v1, double[] v2) {DEBUG_printName("glRectdv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRectf(float x1, float y1, float x2, float y2) {DEBUG_printName("glRectf");
//        GL11.glRectf(x1, y1, x2, y2);
//    }
//
//    public static void qglRectfv(float[] v1, float[] v2) {DEBUG_printName("glRectfv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRecti(int x1, int y1, int x2, int y2) {DEBUG_printName("glRecti");
//        GL11.glRecti(x1, y1, x2, y2);
//    }
//
//    public static void qglRectiv(int[] v1, int[] v2) {DEBUG_printName("glRectiv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRects(short x1, short y1, short x2, short y2) {DEBUG_printName("glRects");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglRectsv(short[] v1, short[] v2) {DEBUG_printName("glRectsv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static int qglRenderMode(int mode) {DEBUG_printName("glRenderMode");
//        return GL11.glRenderMode(mode);
//    }
//
//    public static void qglRotated(double angle, double x, double y, double z) {DEBUG_printName("glRotated");
//        GL11.glRotated(angle, x, y, z);
//    }
//
//    public static void qglRotatef(float angle, float x, float y, float z) {DEBUG_printName("glRotatef");
//        GL11.glRotatef(angle, x, y, z);
//    }
//
//    public static void qglScaled(double x, double y, double z) {DEBUG_printName("glScaled");
//        GL11.glScaled(x, y, z);
//    }
//
//    public static void qglScalef(float x, float y, float z) {DEBUG_printName("glScalef");
//        GL11.glScalef(x, y, z);
//    }
//
...
//    }
//
//    public static void qglSelectBuffer(int size, IntBuffer buffer) {DEBUG_printName("glSelectBuffer");
...
//    }
//
//    public static void qglTexCoord1d(double s) {DEBUG_printName("glTexCoord1d");
//        GL11.glTexCoord1d(s);
//    }
//
//    public static void qglTexCoord1dv(double[] v) {DEBUG_printName("glTexCoord1dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord1f(float s) {DEBUG_printName("glTexCoord1f");
//        GL11.glTexCoord1f(s);
//    }
//
//    public static void qglTexCoord1fv(float[] v) {DEBUG_printName("glTexCoord1fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord1i(int s) {DEBUG_printName("glTexCoord1i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord1iv(int[] v) {DEBUG_printName("glTexCoord1iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord1s(short s) {DEBUG_printName("glTexCoord1s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord1sv(short[] v) {DEBUG_printName("glTexCoord1sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord2d(double s, double t) {DEBUG_printName("glTexCoord2d");
//        GL11.glTexCoord2d(s, t);
//    }
//
//    public static void qglTexCoord2dv(double[] v) {DEBUG_printName("glTexCoord2dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglTexCoord2i(int s, int t) {DEBUG_printName("glTexCoord2i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord2iv(int[] v) {DEBUG_printName("glTexCoord2iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord2s(short s, short t) {DEBUG_printName("glTexCoord2s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord2sv(short[] v) {DEBUG_printName("glTexCoord2sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3d(double s, double t, double r) {DEBUG_printName("glTexCoord3d");
//        GL11.glTexCoord3d(s, t, r);
//    }
//
//    public static void qglTexCoord3dv(double[] v) {DEBUG_printName("glTexCoord3dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3f(float s, float t, float r) {DEBUG_printName("glTexCoord3f");
//        GL11.glTexCoord3f(s, t, r);
//    }
//
//    public static void qglTexCoord3fv(float[] v) {DEBUG_printName("glTexCoord3fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3i(int s, int t, int r) {DEBUG_printName("glTexCoord3i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3iv(int[] v) {DEBUG_printName("glTexCoord3iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3s(short s, short t, short r) {DEBUG_printName("glTexCoord3s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord3sv(short[] v) {DEBUG_printName("glTexCoord3sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4d(double s, double t, double r, double q) {DEBUG_printName("glTexCoord4d");
//        GL11.glTexCoord4d(s, t, r, q);
//    }
//
//    public static void qglTexCoord4dv(double[] v) {DEBUG_printName("glTexCoord4dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4f(float s, float t, float r, float q) {DEBUG_printName("glTexCoord4f");
//        GL11.glTexCoord4f(s, t, r, q);
//    }
//
//    public static void qglTexCoord4fv(float[] v) {DEBUG_printName("glTexCoord4fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4i(int s, int t, int r, int q) {DEBUG_printName("glTexCoord4i");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4iv(int[] v) {DEBUG_printName("glTexCoord4iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4s(short s, short t, short r, short q) {DEBUG_printName("glTexCoord4s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexCoord4sv(short[] v) {DEBUG_printName("glTexCoord4sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglTexEnviv(int target, int pName, int[] params) {DEBUG_printName("glTexEnviv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexGend(int coord, int pName, double param) {DEBUG_printName("glTexGend");
//        GL11.glTexGend(coord, pName, param);
//    }
//
//    public static void qglTexGendv(int coord, int pName, double[] params) {DEBUG_printName("glTexGendv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglTexGeniv(int coord, int pName, int[] params) {DEBUG_printName("glTexGeniv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexImage1D(int target, int level, int internalformat, int width, int border, int format, int type, ByteBuffer pixels) {DEBUG_printName("glTexImage1D");
...
//    }
//
//    public static void qglTexParameteriv(int target, int pName, int[] params) {DEBUG_printName("glTexParameteriv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglTexSubImage1D(int target, int level, int xoffset, int width, int format, int type, ByteBuffer pixels) {DEBUG_printName("glTexSubImage1D");
...
//    }
//
//    public static void qglTranslated(double x, double y, double z) {DEBUG_printName("glTranslated");
//        GL11.glTranslated(x, y, z);
//    }
//
//    public static void qglTranslatef(float x, float y, float z) {DEBUG_printName("glTranslatef");
//        GL11.glTranslatef(x, y, z);
//    }
//
//    public static void qglVertex2d(double x, double y) {DEBUG_printName("glVertex2d");
//        GL11.glVertex2d(x, y);
//    }
//
//    public static void qglVertex2dv(double[] v) {DEBUG_printName("glVertex2dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglVertex2fv(float[] v) {DEBUG_printName("glVertex2fv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex2i(int x, int y) {DEBUG_printName("glVertex2i");
//        GL11.glVertex2i(x, y);
//    }
//
//    public static void qglVertex2iv(int[] v) {DEBUG_printName("glVertex2iv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex2s(short x, short y) {DEBUG_printName("glVertex2s");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex2sv(short[] v) {DEBUG_printName("glVertex2sv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex3d(double x, double y, double z) {DEBUG_printName("glVertex3d");
//        GL11.glVertex3d(x, y, z);
//    }
//
//    public static void qglVertex3dv(double[] v) {DEBUG_printName("glVertex3dv");
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglVertex3i(int x, int y, int z) {DEBUG_printName("glVertex3i");
//        GL11.glVertex3i(x, y, z);
//    }
//
//    public static void qglVertex3iv(int[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglVertex3sv(short[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex4d(double x, double y, double z, double w) {DEBUG_printName("glVertex4d");
//        GL11.glVertex4d(x, y, z, w);
//    }
//
//    public static void qglVertex4dv(double[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex4f(float x, float y, float z, float w) {DEBUG_printName("glVertex4f");
//        GL11.glVertex4f(x, y, z, w);
//    }
//
//    public static void qglVertex4fv(float[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
//    public static void qglVertex4i(int x, int y, int z, int w) {DEBUG_printName("glVertex4i");
//        GL11.glVertex4i(x, y, z, w);
//    }
//
//    public static void qglVertex4iv(int[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
...
//    }
//
//    public static void qglVertex4sv(short[] v) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//
